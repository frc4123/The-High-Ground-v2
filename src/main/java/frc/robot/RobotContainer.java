...
public class RobotContainer {
    ...
    private final AutoAimCommand autoAimCommand = new AutoAimCommand(driveSubsystem, vision, this,
    ...
    private final IntakeWheelsInCommand intakeWheelsInCommand = new IntakeWheelsInCommand(intakeWheelsSubsystem);
    private final IntakeWheelsOutCommand intakeWheelsOutCommand = new IntakeWheelsOutCommand(intakeWheelsSubsystem);
    ...
    /**
     * The {@link RobotContainer} object. Instantiates button bindings and sets the
     * default command.
     *
     * <p>
     * You should set up all configuration of the robot subsystems, commands, and
     * helper functions in this class as if this were a typical "Main" class. Make
     * sure you only make one object for these, and use getters as necessary.
     */
    ...
    /**
     * Configures the button bindings for all controllers.
     */
    private void configureButtonBindings() {
        ...
        povLeft.whileHeld(indexOutCommand);
        povRight.whileHeld(indexInCommand);
    }
    ...
    public Command getAutonomousCommand() {
        return new SequentialCommandGroup(shuffleBoardHelper.getSelectedCommand(), autoAimCommand.withTimeout(2),
