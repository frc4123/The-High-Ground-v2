...
public class IntakeWheelsOutCommand extends CommandBase {
    IntakeWheelsSubsystem intakeWheelsSubsystem;

    /** Creates a new IntakeWheelsOutCommand. */
    public IntakeWheelsOutCommand(IntakeWheelsSubsystem intakeWheelsSubsystem) {
